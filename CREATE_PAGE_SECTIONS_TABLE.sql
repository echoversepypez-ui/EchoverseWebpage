...
('how_it_works', 'How It Works', 'Get started in just 4 simple steps', '{"steps":[{"number":1,"title":"Apply","description":"Submit your application with your qualifications and teaching experience"},{"number":2,"title":"Review","description":"Our team verifies your credentials and assesses your fit for available positions"},{"number":3,"title":"Onboard","description":"Complete a quick orientation and get access to your teaching platform"},{"number":4,"title":"Start Teaching","description":"Connect with students and begin earning from day one"}]}'),
